...
# TODO: remove stt_api_test.py#test_srt_timestamp_over_one_minute test/aichat/serve/stt_api_test.py:117
# TODO: remove stt_api_test.py#test_oversized_upload_rejected test/aichat/serve/stt_api_test.py:139
# TODO: remove stt_api_test.py#test_invalid_filename_null_byte test/aichat/serve/stt_api_test.py:158
# TODO: remove stt_api_test.py#test_non_wav_rejected test/aichat/serve/stt_api_test.py:171
...
# TODO: remove tts_api_test.py#test_missing_model_parameter test/aichat/serve/tts_api_test.py:79
# TODO: remove tts_api_test.py#test_model_not_found test/aichat/serve/tts_api_test.py:94
# TODO: remove tts_api_test.py#test_invalid_json test/aichat/serve/tts_api_test.py:113
# TODO: remove tts_api_test.py#test_speech_generation_error test/aichat/serve/tts_api_test.py:125
...
# TODO: remove embeddings_api_test.py#test_successful_embeddings_generation test/aichat/serve/embeddings_api_test.py:21
...
# TODO: remove image_generation_api_test.py#test_successful_image_generation test/aichat/serve/image_generation_api_test.py:31
...
def _(ctx, monkeypatch):
    ...
    ctx["file"] = f
    ctx["kwargs"] = {"file": f, "model": "parakeet"}
    monkeypatch.setattr(
        stt_api,
        "model_settings",
...
def _(ctx, exc, text, monkeypatch):
    ...
    tx = AsyncMock(
        side_effect=RuntimeError(text) if exc == "RuntimeError" else ValueError(text)
    )
...
def _(ctx, exc, text, monkeypatch):
    ...
    monkeypatch.setattr(
        embeddings_api, "generate_embeddings", AsyncMock(side_effect=RuntimeError(text))
    )
...
def _(ctx, exc, text, monkeypatch):
    ...
    monkeypatch.setattr(
        image_generation_api,
        "generate_image",
        AsyncMock(side_effect=RuntimeError(text)),
    )
