...
_CATALOG = {
    "mixtral-8x7b-instruct": {"type": "llm", "free": True},
    "mixtral": {"type": "llm", "free": True},
    "premium-x": {"type": "llm", "free": False},
}
...
def given_catalog(free_model, premium_model, monkeypatch):
    monkeypatch.setattr(
        model_settings,
        "models",
        {
