...
def given_base_handler(ctx):
    # The ctx fixture already seeds a BareHandler; this given exists so the
    # "Base class defaults" scenario opens with a Given step and documents
    # the fixture dependency explicitly.
...
@given("a registered disabled server using the default handler")
