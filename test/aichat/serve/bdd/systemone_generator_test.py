...
def then_converted(ctx):
    ...
    # The conversion is a faithful passthrough: the outputs list, including
    # the embedded result_json string, survives unchanged.
    assert ctx["converted"] == {
        "outputs": [{"name": "result_json", "data": ['{"answers": []}']}]
    }
